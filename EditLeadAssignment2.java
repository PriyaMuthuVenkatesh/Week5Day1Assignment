...
public class EditLeadAssignment2 extends BaseClass{
	@Test
...
//		* 8	Enter first name
		driver.findElement(By.xpath("//input[@name='firstName' and @id='ext-gen248']")).sendKeys("Priya");
		 Thread.sleep(2000);
